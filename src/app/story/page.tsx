    ...
    <div className='relative min-h-screen'>
      ...
      <main className='relative z-10 container pt-24 sm:pt-28 md:pt-32 lg:pt-36 xl:pt-40'>
        <HorizontalScrollContainer ref={scrollContainerRef} onScrollChange={handleScrollChange}>
          ...
          {/* image 2 */}
          <div className='relative lg:max-w-[50vw] lg:min-w-[500px] lg:h-[60vh] lg:ml-[1vw] lg:mt-2 w-full h-auto px-4 sm:px-6 my-4 sm:my-6 lg:my-0'>
            <div className='relative overflow-hidden rounded-lg'>
              <ImageZoom src={Image2} alt='Story Image 2' className='w-full lg:h-[60vh] h-[220px] sm:h-[280px] md:h-[300px] object-cover' />
            </div>
          </div>
          ...
          <div className='relative lg:max-w-[50vw] lg:min-w-[500px] lg:h-[60vh] lg:ml-[1vw] lg:mt-2 w-full h-auto px-4 sm:px-6 my-4 sm:my-6 lg:my-0'>
            <div className='relative overflow-hidden rounded-lg'>
              <ImageZoom src={Image3} alt='Story Image 3' className='w-full lg:h-[60vh] h-[220px] sm:h-[280px] md:h-[300px] object-cover' />
            </div>
          </div>
          ...
          <div className='relative lg:max-w-[50vw] lg:min-w-[500px] lg:h-[60vh] lg:ml-[1vw] lg:mt-2 w-full h-auto px-4 sm:px-6 my-4 sm:my-6 lg:my-0'>
            <div className='relative overflow-hidden rounded-lg'>
              <ImageZoom src={Image4} alt='Story Image 4' className='w-full lg:h-[60vh] h-[220px] sm:h-[280px] md:h-[300px] object-cover' />
            </div>
          </div>
